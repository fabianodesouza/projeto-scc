...
<html lang="pt-br">
    ...
    <body class="body_scc ">
        ...
        <nav class="navbar navbar-expand-lg bg-dark">
            ...
            <div class="seta_home_pesq">
                <a href="home.php" style="color: red;">
                    <i class="bi bi-arrow-left-circle-fill seta" style="font-size: 30px;"></i>
                </a>
            </div>
            <div class="container-fluid menu">
                <a class="navbar-brand text-white" href="home.php"><img class="logo_home_pesq" src="assets/img/logo6.png" alt="Logo  do sistema cadastro consulta"></a>

                  <a class="nav-link text-white me-5 link_home" href="home.php"><strong>HOME</strong></a>

              
            </div>
            <div class="d-flex sair_pesq_home">
